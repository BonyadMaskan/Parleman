...
// متغیر ثابت برای این پروژه تعریف نمی‌شود، چون آدرس کامل در خود شیت است.
...
function createMemberCard(member) {
    ...
    // !!! مهم: نام این ستون را با نام ستونی که آدرس کامل تصاویر را در آن قرار داده‌اید، جایگزین کنید.
    // مثلاً اگر نام ستون شما "آدرس کامل تصویر" است، 'آدرس تصویر' را به 'آدرس کامل تصویر' تغییر دهید.
    const fullImageAddress = member['آدرس تصویر'] || member['آدرس_تصویر'] || ''; 
    
    // اگر آدرس کامل موجود بود، از آن استفاده می‌کنیم.
    const imageURL = fullImageAddress ? fullImageAddress : 'https://via.placeholder.com/250x250.png?text=Image+Not+Found'; 
    
    // خواندن داده‌های فارسی
    ...
    return `
        <div class="member-card">
            <img 
                ...
                alt="تصویر ${name}" 
                loading="lazy" 
                onerror="this.onerror=null;this.src='https://via.placeholder.com/250x250.png?text=URL+Issue';"
            >
...
function csvToJson(csv) {
    ...
    for (let i = 1; i < lines.length; i++) {
        // جدا کردن محتوای ردیف با فرض عدم وجود کاما در خود محتوا
